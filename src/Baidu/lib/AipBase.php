...
namespace fyflzjz\speech\Baidu\lib;
...
class AipBase {
     ...
     */
    public function __construct($appId, $apiKey, $secretKey, $logPath){
    ...
    private function getAuthFilePath(){
		$logPath = $this->logPath ? $this->logPath : dirname(__FILE__);
		
        return $logPath . DIRECTORY_SEPARATOR . md5($this->apiKey).'token';
    }
